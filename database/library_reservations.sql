...
CREATE TABLE `reservations` (
  ...
  CONSTRAINT `book_id` FOREIGN KEY (`id`) REFERENCES `books` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `reservations` VALUES (1,2,1,'2021-12-11','2021-12-09'),(2,2,3,'2021-11-09','2020-11-19'),(3,1,1,'1999-12-29','2000-01-14'),(7,7,7,'2021-11-01','2021-11-15');
